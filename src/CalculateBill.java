...
public class CalculateBill extends JFrame implements ActionListener{
    ...
    CalculateBill() {
        ...
        // To fetch exist meter numbers and store in choice 
        try {
            Conn c  = new Conn();
        ...
        //based on the meter number store name and address 
        ...
        //If i choose diff. meter number then name and address is automatically changed
